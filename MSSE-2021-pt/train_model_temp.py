...
if __name__ == "__main__":
    ...
    if args.run_sanity_validation:
        ...
        if valid_dataloader != None:
            with torch.no_grad():
                for inputs, labels in valid_dataloader:
                    ...
                    batch_cm = confusion_matrix(labels.cpu().numpy(), predicted.cpu().numpy(), labels=np.arange(num_classes))
                    cm += batch_cm
                    ...
                    n_batches += 1
        # Calculate balanced accuracy from the confusion matrix
        ...
        balanced_epoch_val_acc = np.mean(balanced_accuracy)

        total_samples = cm.sum()  # Sum of all elements in confusion matrix
        accuracy = true_positive.sum() / total_samples  # Total correct predictions / total samples
        print(f"Epoch {epoch + 1} Accuracy: {accuracy:.2%}")

        print(f"Sanity Validation Accuracy: {epoch_val_acc:.2%}")
        print(f"Sanity Balanced Validation Accuracy: {balanced_epoch_val_acc:.2%}")
    ...
    #     balanced_training_accuracy = 0.0
    #     n_batches = 0
    ...
    #         )
    #         batch_balanced_acc = balanced_accuracy_score(preds.cpu().detach().numpy(), labels.cpu().detach().numpy())

    #         training_accuracy += batch_acc
    #         balanced_training_accuracy+=batch_balanced_acc
    #         # Calculate loss
    #         loss = criterion(outputs, labels)
    ...
    #     epoch_balanced_train_accuracy = balanced_training_accuracy / n_batches

    #     # Validation loop
    #     model.eval()
    #     val_loss = 0.0
    #     validation_accuracy = 0.0
    #     balanced_validation_accuracy = 0.0
    #     n_batches = 0
    #     epoch_val_loss = None
    #     epoch_val_acc = None
    #     if valid_dataloader != None:
    ...
    #                 balanced_validation_accuracy+=batch_balanced_acc
    #                 # Calculate loss
    #                 loss = criterion(outputs, labels)
    ...
    #         epoch_balanced_val_acc = balanced_validation_accuracy / n_batches
    ...
    #         if not args.silent:
    #             print(
    #                 f"Epoch [{epoch+1}/{args.num_epochs}], Runtime: {epoch_duration:.2f} seconds, Train Loss: {epoch_train_loss:.4f}, Train Accuracy: {epoch_train_accuracy:.2%}, Balanced Train Accuracy:{epoch_balanced_train_accuracy:.2%}, Val Loss: {val_loss:.4f}, Val Accuracy: {epoch_val_acc:.2%}, Balanced Val Accuracry: {epoch_balanced_val_acc:.2%}"
    #             )
    #     else:
    #         if not args.silent:
    #             print(
    #                 f"Epoch [{epoch+1}/{args.num_epochs}], Runtime: {epoch_duration:.2f} seconds, Train Loss: {epoch_train_loss:.4f}, Train Accuracy: {epoch_train_accuracy:.2%}, Balanced Train Accuracy:{epoch_balanced_train_accuracy:.2%}"
    #             )
    ...
    #             "balanced_train_acc": epoch_balanced_train_accuracy,
    #             "val_loss": epoch_val_loss,
    #             "val_acc": epoch_val_acc,
    #             "balanced_val_acc": epoch_balanced_val_acc,
    #         }
    #     )
