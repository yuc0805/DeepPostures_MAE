...
if __name__ == "__main__":
    ...
    if args.run_sanity_validation:
        ...
        if valid_dataloader != None:
            ...
            accuracy, balanced_accuracy = compute_accuracy_from_confusion_matrix(cm)
    ...
    for epoch in tqdm(range(args.num_epochs)):
        ...
        for inputs, labels in train_dataloader:
            ...
            # print(f"Loss: {loss.item()*inputs.size(0)}")
            n_batches += 1
        ...
        print(f"Accuracy: {accuracy:.2%}, Balanced Accuracy {balanced_accuracy:.2%}, loss: {epoch_train_loss:.4f}")
